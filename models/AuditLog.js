...
// module.exports = mongoose.model('AuditLog', auditLogSchema); workable
...
const auditLogSchema = new mongoose.Schema({
  ...
  action: {
    type: String,
    enum: [
      'created','updated','draft_saved','sent',
      'opened','signed','completed','cancelled','expired',
    ],
    required: true,
  },
  performed_by: {
  ...
  client_time: { type: String, default: '' },
